...
import de.gishmo.gwt.editor.client.annotation.*;
...
public class EditorErrorTest extends TestCase {
  ...
  @de.gishmo.gwt.editor.client.annotation.IsEditor(Workgroup.class)
...
//  }
  ...
  public void testNestedErrors() {
    ...
    SimpleBeanEditorDriver<Workgroup, WorkgroupNestedErrorsEditor> driver = new WorkgroupNestedErrorsEditorEditorDriverImpl();
