 ...
 * the License.
 */
package de.gishmo.gwt.editor.client;
...
import de.gishmo.gwt.editor.client.SimpleBeanEditorTest.PersonEditorWithDelegate;
import de.gishmo.gwt.editor.client.SimpleBeanEditorTest.PersonEditorWithOptionalAddressEditor;
...
public class DirtyEditorTest extends TestCase {
  ...
  public void testDirty() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditor> driver = new PersonEditorEditorDriverImpl();
  ...
  public void testDirtyWithDelegate() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithDelegate> driver = new PersonEditorWithDelegateEditorDriverImpl();
    driver.initialize(editor);
    driver.edit(person);
  ...
  public void testDirtyWithOptionalEditor() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithOptionalAddressEditor> driver =
        new PersonEditorWithOptionalAddressEditorEditorDriverImpl();
    driver.initialize(editor);
    driver.edit(person);
...
//  }
  ...
  public void testDirtyOptionalList() {
    SimpleBeanEditorDriver<Workgroup, WorkgroupEditor> driver = new WorkgroupEditorEditorDriverImpl();
