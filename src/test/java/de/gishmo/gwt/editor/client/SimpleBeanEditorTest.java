...
public class SimpleBeanEditorTest extends TestCase {
  ...
  @de.gishmo.gwt.editor.client.annotation.IsEditor(DepartmentWithList.class)
...
//  }
   ...
   * >issue 6016</a>
   */
  @de.gishmo.gwt.editor.client.annotation.IsEditor(Department.class)
...
//  }
  ...
  @de.gishmo.gwt.editor.client.annotation.IsEditor(Person.class)
...
//  }
  ...
  @de.gishmo.gwt.editor.client.annotation.IsEditor(PersonWithList.class)
...
//  }
   ...
   */
  @de.gishmo.gwt.editor.client.annotation.IsEditor(Address.class)
...
//  }
  ...
  public void testAliasedEditors() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithAliasedSubEditors> driver =
        new PersonEditorWithAliasedSubEditorsEditorDriverImpl();
    driver.initialize(editor);
    driver.edit(person);
  ...
  public void testDelegatePath() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithManagerNameWithDelegate> driver =
            new PersonEditorWithManagerNameWithDelegateEditorDriverImpl();
    driver.initialize(editor);
    driver.edit(person);
  ...
  public void testEditorOfSuperclass() {
    ...
    SimpleBeanEditorDriver<DepartmentWithList, DepartmentWithListEditor> driver = new DepartmentWithListEditorEditorDriverImpl();
    driver.initialize(editor);
  ...
  public void testEditorWithGenericSubEditors() {
    SimpleBeanEditorDriver<Department, EditorWithGenericSubEditors> driver = new EditorWithGenericSubEditorsEditorDriverImpl();
  ...
  public void testIsEditorView() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithAddressEditorView> driver =
        new PersonEditorWithAddressEditorViewEditorDriverImpl();
  ...
  public void testIsEditorViewWithCoEditorA() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithCoAddressEditorView> driver =
        new PersonEditorWithCoAddressEditorViewEditorDriverImpl();
  ...
  public void testLeafValueEditorDeclaredInSlot() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithLeafAddressEditor> driver =
        new PersonEditorWithLeafAddressEditorEditorDriverImpl();
...
//  }
  ...
  public void testListEditorChainFlush() {
    SimpleBeanEditorDriver<PersonWithList, PersonWithListEditor> driver = new PersonWithListEditorEditorDriverImpl();
  ...
  public void testMultipleBinding() {
    SimpleBeanEditorDriver<Person, PersonEditorWithMultipleBindings> driver =
        new PersonEditorWithMultipleBindingsEditorDriverImpl();
  ...
  public void testValueAwareEditorInDeclaredSlot() {
    SimpleBeanEditorDriver<Person, PersonEditorWithValueAwareAddressEditor> driver =
        new PersonEditorWithValueAwareAddressEditorEditorDriverImpl();
  ...
  public void testValueAwareLeafValueEditorInDeclaredSlot() {
    ...
    SimpleBeanEditorDriver<Person, PersonEditorWithValueAwareLeafAddressEditor> driver =
        new PersonEditorWithValueAwareLeafAddressEditorEditorDriverImpl();
