 ...
 * the License.
 */
package de.gishmo.gwt.editor.generated;
...
import de.gishmo.gwt.editor.generated.SimpleBeanEditorTest.*;
...
public class DirtyEditorTest extends TestCase {
  ...
  public void testDirtyWithDelegate() {
    ...
    PersonEditorWithDelegateDriver driver = new SimpleBeanEditorTest_PersonEditorWithDelegateDriver_Impl();
    driver.initialize(editor);
    driver.edit(person);
