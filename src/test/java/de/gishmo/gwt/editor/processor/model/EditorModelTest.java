...
public class EditorModelTest {
  ...
  public void testBasicAttributes() {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(PersonEditorDriver.class), sbedType);
  ...
  public void testCompositeAndLeafValueEditor() {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(CompositeAndLeafEditorDriver.class), sbedType);

    assertEquals(typeMirrorFor(CompositeAndLeafEditorDriver.AProxy.class),
            m.getProxyType());
    assertEquals(typeMirrorFor(CompositeAndLeafEditorDriver.AEditor.class),
            m.getEditorType());
    ...
    assertEquals(typeMirrorFor(CompositeAndLeafEditorDriver.BProxy.class),
            composed.getEditedType());
    assertEquals(typeMirrorFor(CompositeAndLeafEditorDriver.BEditor.class),
  ...
  public void testCompositeDriver()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(CompositeEditorDriver.class), sbedType);
    ...
    Assert.assertEquals(Arrays.asList("address", "address.city", "address.street", "person", "person.has",
    ...
    Assert.assertEquals(Arrays.asList("address", "address.city", "address.street", "person()",
...
//  }
  ...
  public void testDottedPath()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(DottedPathEditorDriver.class), sbedType);
    ...
    Assert.assertEquals("object.getAddress() != null",
            fields.get(1).getBeanOwnerGuard("object"));
    ...
    assertEquals(typeMirrorFor(Address.class),
            fields.get(1).getPropertyOwnerType());
  }
  ...
  public void testIsEditor()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(UsesIsEditorDriver.class), sbedType);

    List<EditorProperty> data = m.getEditorData();
    assertNotNull(data);
    Assert.assertEquals(2, data.size());
    Assert.assertEquals(Arrays.asList("b", "b.string"),
            Arrays.asList(data.get(0).getPath(), data.get(1).getPath()));
    Assert.assertEquals(
            Arrays.asList("bEditor().asEditor()", "stringEditor()"),
            Arrays.asList(data.get(0).getSimpleExpression(),
                    data.get(1).getSimpleExpression()));
  }
  ...
  public void testIsEditorAndEditor()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(UsesIsEditorAndEditorDriver.class), sbedType);

    List<EditorProperty> data = m.getEditorData();
    assertNotNull(data);
    Assert.assertEquals(4, data.size());
    Assert.assertEquals(Arrays.asList("b", "b.string", "b", "b.string"),
            Arrays.asList(data.get(0).getPath(), data.get(1).getPath(), data.get(2).getPath(),
                    data.get(3).getPath()));
    Assert.assertEquals(Arrays.asList("bEditor().asEditor()",
            "bEditor().asEditor().coEditor()", "bEditor()",
            "bEditor().viewEditor()"), Arrays.asList(data.get(0).getExpression(),
            data.get(1).getExpression(), data.get(2).getExpression(),
            data.get(3).getExpression()));
    Assert.assertEquals(
            Arrays.asList(true, false, true, false),
            Arrays.asList(data.get(0).isDelegateRequired(),
                    data.get(1).isDelegateRequired(), data.get(2).isDelegateRequired(),
  ...
  public void testListDriver()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(ListEditorDriver.class), sbedType);
    assertEquals(typeMirrorFor(Person.class), m.getProxyType());
  ...
  public void testMethodEditors()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(PersonEditorDriverUsingMethods.class), sbedType);
    List<EditorProperty> fields = m.getEditorData();
    Assert.assertEquals(2, fields.size());
...
//  }
  ...
  public void testZeroLengthPath()  {
    EditorModel m = new EditorModel(null, new EditorTypes(types, elements),
            typeMirrorFor(PersonEditorWithAliasedSubEditorsDriver.class), sbedType);
    List<EditorProperty> fields = m.getEditorData();
  ...
  private void checkPersonHasHas(EditorProperty editorField) {
    ...
    assertEquals(typeMirrorFor(SimpleEditor.class),
            raw(editorField.getEditorType()));
  ...
  interface CompositeEditorDriver extends SimpleBeanEditorDriver<CompositeObject, CompositeProxyEditor> {
  }

  interface CyclicEditorDriver extends SimpleBeanEditorDriver<CyclicEditorDriver.AProxy, CyclicEditorDriver.AEditor> {
  ...
  interface DottedPathEditorDriver extends SimpleBeanEditorDriver<Person, DottedPathEditorDriver.PersonEditor> {
  ...
  interface MissingGetterEditorDriver extends SimpleBeanEditorDriver<MissingGetterEditorDriver.AProxy, MissingGetterEditorDriver.AEditor> {
    interface AProxy extends EntityProxy {
    }
  ...
  static class PersonEditor implements Editor<Person> {
    ...
    @Editor.Ignore
    public SimpleEditor<String> ignoredPublic;
  }
  ...
  interface PersonEditorWithBadPrimitiveAccessDriver extends SimpleBeanEditorDriver<Person, PersonEditorWithBadPrimitiveAccess> {
  }
  ...
  interface PersonEditorDriverUsingMethods extends SimpleBeanEditorDriver<Person, PersonEditorUsingMethods> {
  }

  interface PersonRequestFactory extends RequestFactory {
  }

  interface TooManyInterfacesEditorDriver extends SimpleBeanEditorDriver<CompositeObject, CompositeProxyEditor>, java.io.Serializable {
  }

  interface UnparameterizedEditorEditorDriver extends SimpleBeanEditorDriver<UnparameterizedEditorEditorDriver.AProxy, UnparameterizedEditorEditorDriver.AEditor> {
    interface AProxy extends EntityProxy {
    }
  ...
  interface UsesIsEditorDriver extends SimpleBeanEditorDriver<UsesIsEditorDriver.AProxy, UsesIsEditorDriver.AEditor> {
    interface AProxy extends EntityProxy {
      BProxy getB();
    }
  ...
  interface UsesIsEditorAndEditorDriver extends SimpleBeanEditorDriver<UsesIsEditorAndEditorDriver.AProxy, UsesIsEditorAndEditorDriver.AEditor> {
    interface AProxy extends EntityProxy {
      BProxy getB();
    }
  ...
  interface CompositeAndLeafEditorDriver extends SimpleBeanEditorDriver<CompositeAndLeafEditorDriver.AProxy, CompositeAndLeafEditorDriver.AEditor> {
    interface AProxy extends EntityProxy {
      BProxy getB();
    }
    ...
    interface OptionalBEditor extends CompositeEditor<BProxy, BProxy, BEditor>, LeafValueEditor<BProxy> {
